...
class JupiterMoons(object):
    ...
    @staticmethod
    def rectangular_positions_jovian_equatorial(epoch, tofk5=True, solar=False):
        """This method computes the rectangular geocentric position of Jupiter's
        satellites for a given epoch, using the E5-theory.
        ...
        # Calculate rectangular Coordinates X, Y and Z in Jupiter's radii of Io (1), Europa (2),
        # Ganimed (3) and Callisto (4)
        Io = [X_1, Y_1, Z_1]#JupiterMoons.apparent_rectangular_coordinates(epoch, X_1, Y_1, Z_1, OMEGA_ascending_node_jupiter, psi_corrected, i_ecliptic_jupiter, lambda_0, beta_0, D)
        Europa = [X_2, Y_2, Z_2]#JupiterMoons.apparent_rectangular_coordinates(epoch, X_2, Y_2, Z_2, OMEGA_ascending_node_jupiter, psi_corrected, i_ecliptic_jupiter, lambda_0, beta_0, D)
        Ganimed = [X_3, Y_3, Z_3]#JupiterMoons.apparent_rectangular_coordinates(epoch, X_3, Y_3, Z_3, OMEGA_ascending_node_jupiter, psi_corrected, i_ecliptic_jupiter, lambda_0, beta_0, D)
        Callisto = [X_4, Y_4, Z_4]#JupiterMoons.apparent_rectangular_coordinates(epoch, X_4, Y_4, Z_4, OMEGA_ascending_node_jupiter, psi_corrected, i_ecliptic_jupiter, lambda_0, beta_0, D)
