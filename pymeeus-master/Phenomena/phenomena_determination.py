...
class Phenomena(object):
    ...
    def crossing_point_advanced_accuracy(epoch_start, time_span, time_step=1.157401129603386e-05):
        ...
        for i in range(time_span):
            ...
            z_tmp  = - position_matrix[:, 2];

            a = z_tmp**2 * (1+tan(alpha_rad))**2
            b  = -2*z_tmp*tan(alpha_rad)
            c = 1 - r**2
            ...
            r_width = np.abs(-1+x_1*tan(slpha_rad))
