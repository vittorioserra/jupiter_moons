...
from pymeeus_optimized.Sun import Sun
...
class JupiterMoons(object):
    ...
    def jupiter_system_angles(epoch):
        ...
        while DELTA != DELTA_old and iterations < 3:
    ...
    def rectangular_positions_jovian_equatorial(
        ...
        for the effects of different light-time
         and perspective distance or not
        ...
        sum1 = 0.47259 * sin(2 * radians(l_1 - l_2)) \
               - 0.03478 * sin(radians(pi_3 - pi_4)) \
               + 0.01081 * sin(radians(l_2 - 2 * l_3 + pi_3)) \
               + 0.00738 * sin(radians(PHI_lambda)) \
               + 0.00713 * sin(radians(l_2 - 2 * l_3 + pi_2)) \
               - 0.00674 * sin(radians(pi_1 + pi_3 - 2 * PI - 2 * G)) \
               + 0.00666 * sin(radians(l_2 - 2 * l_3 + pi_4)) \
               + 0.00445 * sin(radians(l_1 - pi_3)) \
               - 0.00354 * sin(radians(l_1 - l_2)) \
               - 0.00317 * sin(radians(2 * psi - 2 * PI)) \
               + 0.00265 * sin(radians(l_1 - pi_4)) \
               - 0.00186 * sin(radians(G)) \
               + 0.00162 * sin(radians(pi_2 - pi_3)) \
               + 0.00158 * sin(radians(4 * (l_1 - l_2))) \
               - 0.00155 * sin(radians(l_1 - l_3)) \
               - 0.00138 * sin(radians(psi + omega_3 - 2 * PI - 2 * G)) \
               - 0.00115 * sin(radians(2 * (l_1 - 2 * l_2 + omega_2))) \
               + 0.00089 * sin(radians(pi_2 - pi_4)) \
               + 0.00085 * sin(radians(l_1 + pi_3 - 2 * PI - 2 * G)) \
               + 0.00083 * sin(radians(omega_2 - omega_3)) \
               + 0.00053 * sin(radians(psi - omega_2))

        sum2 = 1.06476 * sin(radians(2 * (l_2 - l_3))) \
               + 0.04256 * sin(radians(l_1 - 2 * l_2 + pi_3)) \
               + 0.03581 * sin(radians(l_2 - pi_3)) \
               + 0.02395 * sin(radians(l_1 - 2 * l_2 + pi_4)) \
               + 0.01984 * sin(radians(l_2 - pi_4)) \
               - 0.01778 * sin(radians(PHI_lambda)) \
               + 0.01654 * sin(radians(l_2 - pi_2)) \
               + 0.01334 * sin(radians(l_2 - 2 * l_3 + pi_2)) \
               + 0.01294 * sin(radians(pi_3 - pi_4)) \
               - 0.01142 * sin(radians(l_2 - l_3)) \
               - 0.01057 * sin(radians(G)) \
               - 0.00775 * sin(radians(2 * (psi - PI))) \
               + 0.00524 * sin(radians(2 * (l_1 - l_2))) \
               - 0.00460 * sin(radians((l_1 - l_3))) \
               + 0.00316 * sin(radians(psi - 2 * G + omega_3 - 2 * PI)) \
               - 0.00203 * sin(radians(pi_1 + pi_3 - 2 * PI - 2 * G)) \
               + 0.00146 * sin(radians(psi - omega_3)) \
               - 0.00145 * sin(radians(2 * G)) \
               + 0.00125 * sin(radians(psi - omega_4)) \
               - 0.00115 * sin(radians(l_1 - 2 * l_3 + pi_3)) \
               - 0.00094 * sin(radians(2 * (l_2 - omega_2))) \
               + 0.00086 * sin(radians(2 * (l_1 - 2 * l_2 + omega_2))) \
               - 0.00086 * sin(radians(5 * G_ - 2 * G + 52.225)) \
               - 0.00078 * sin(radians(l_2 - l_4)) \
               - 0.00064 * sin(radians(3 * l_3 - 7 * l_4 + 4 * pi_4)) \
               + 0.00064 * sin(radians(pi_1 - pi_4)) \
               - 0.00063 * sin(radians(l_1 - 2 * l_3 + pi_4)) \
               + 0.00058 * sin(radians(omega_3 - omega_4)) \
               + 0.00056 * sin(radians(2 * (psi - PI - G))) \
               + 0.00056 * sin(radians(2 * (l_2 - l_4))) \
               + 0.00055 * sin(radians(2 * (l_1 - l_3))) \
               + 0.00052 * sin(radians(3 * l_3 - 7 * l_4 + pi_3 + 3 * pi_4)) \
               - 0.00043 * sin(radians(l_1 - pi_3)) \
               + 0.00041 * sin(radians(5 * (l_2 - l_3))) \
               + 0.00041 * sin(radians(pi_4 - PI)) \
               + 0.00032 * sin(radians(omega_2 - omega_3)) \
               + 0.00032 * sin(radians(2 * (l_3 - G - PI)))

        sum3 = 0.16490 * sin(radians(l_3 - pi_3)) \
               + 0.09081 * sin(radians(l_3 - pi_4)) \
               - 0.06907 * sin(radians(l_2 - l_3)) \
               + 0.03784 * sin(radians(pi_3 - pi_4)) \
               + 0.01846 * sin(radians(2 * (l_3 - l_4))) \
               - 0.01340 * sin(radians(G)) \
               - 0.01014 * sin(radians(2 * (psi - PI))) \
               + 0.00704 * sin(radians(l_2 - 2 * l_3 + pi_3)) \
               - 0.00620 * sin(radians(l_2 - 2 * l_3 + pi_2)) \
               - 0.00541 * sin(radians(l_3 - l_4)) \
               + 0.00381 * sin(radians(l_2 - 2 * l_3 + pi_4)) \
               + 0.00235 * sin(radians(psi - omega_3)) \
               + 0.00198 * sin(radians(psi - omega_4)) \
               + 0.00176 * sin(radians(PHI_lambda)) \
               + 0.00130 * sin(radians(3 * (l_3 - l_4))) \
               + 0.00125 * sin(radians(l_1 - l_3)) \
               - 0.00119 * sin(radians(5 * G_ - 2 * G + 52.225)) \
               + 0.00109 * sin(radians(l_1 - l_2)) \
               - 0.00100 * sin(radians(3 * l_3 - 7 * l_4 + 4 * pi_4)) \
               + 0.00091 * sin(radians(omega_3 - omega_4)) \
               + 0.00080 * sin(radians(3 * l_3 - 7 * l_4 + pi_3 + 3 * pi_4)) \
               - 0.00075 * sin(radians(2 * l_2 - 3 * l_3 + pi_3)) \
               + 0.00072 * sin(radians(pi_1 + pi_3 - 2 * PI - 2 * G)) \
               + 0.00069 * sin(radians(pi_4 - PI)) \
               - 0.00058 * sin(radians(2 * l_3 - 3 * l_4 + pi_4)) \
               - 0.00057 * sin(radians(l_3 - 2 * l_4 + pi_4)) \
               + 0.00056 * sin(radians(l_3 + pi_3 - 2 * PI - 2 * G)) \
               - 0.00052 * sin(radians(l_2 - 2 * l_3 + pi_1)) \
               - 0.00050 * sin(radians(pi_2 - pi_3)) \
               + 0.00048 * sin(radians(l_3 - 2 * l_4 + pi_3)) \
               - 0.00045 * sin(radians(2 * l_2 - 3 * l_3 + pi_4)) \
               - 0.00041 * sin(radians(pi_2 - pi_4)) \
               - 0.00038 * sin(radians(2 * G)) \
               - 0.00037 * sin(radians(pi_3 - pi_4 + omega_3 - omega_4)) \
               - 0.00032 * sin(radians(3 * l_3 - 7 * l_4 + 2 * pi_3 + 2 * pi_4)) \
               + 0.00030 * sin(radians(4 * (l_3 - l_4))) \
               + 0.00029 * sin(radians(l_3 + pi_4 - 2 * PI - 2 * G)) \
               - 0.00028 * sin(radians(omega_3 + psi - 2 * PI - 2 * G)) \
               + 0.00026 * sin(radians(l_3 - PI - G)) \
               + 0.00024 * sin(radians(l_2 - 3 * l_3 + 2 * l_4)) \
               + 0.00021 * sin(radians(2 * (l_3 - PI - G))) \
               - 0.00021 * sin(radians(l_3 - pi_2)) \
               + 0.00017 * sin(radians(2 * (l_3 - pi_3)))

        sum4 = 0.84287 * sin(radians(l_4 - pi_4)) \
               + 0.03431 * sin(radians(pi_4 - pi_3)) \
               - 0.03305 * sin(radians(2 * (psi - PI))) \
               - 0.03211 * sin(radians(G)) \
               - 0.01862 * sin(radians(l_4 - pi_3)) \
               + 0.01186 * sin(radians(psi - omega_4)) \
               + 0.00623 * sin(radians(l_4 + pi_4 - 2 * G - 2 * PI)) \
               + 0.00387 * sin(radians(2 * (l_4 - pi_4))) \
               - 0.00284 * sin(radians(5 * G_ - 2 * G + 52.225)) \
               - 0.00234 * sin(radians(2 * (psi - pi_4))) \
               - 0.00223 * sin(radians(l_3 - l_4)) \
               - 0.00208 * sin(radians(l_4 - PI)) \
               + 0.00178 * sin(radians(psi + omega_4 - 2 * pi_4)) \
               + 0.00134 * sin(radians(pi_4 - PI)) \
               + 0.00125 * sin(radians(2 * (l_4 - G - PI))) \
               - 0.00117 * sin(radians(2 * G)) \
               - 0.00112 * sin(radians(2 * (l_3 - l_4))) \
               + 0.00107 * sin(radians(3 * l_3 - 7 * l_4 + 4 * pi_4)) \
               + 0.00102 * sin(radians(l_4 - G - PI)) \
               + 0.00096 * sin(radians(2 * l_4 - psi - omega_4)) \
               + 0.00087 * sin(radians(2 * (psi - omega_4))) \
               - 0.00085 * sin(radians(3 * l_3 - 7 * l_4 + pi_3 + 3 * pi_4)) \
               + 0.00085 * sin(radians(l_3 - 2 * l_4 + pi_4)) \
               - 0.00081 * sin(radians(2 * (l_4 - psi))) \
               + 0.00071 * sin(radians(l_4 + pi_4 - 2 * PI - 3 * G)) \
               + 0.00061 * sin(radians(l_1 - l_4)) \
               - 0.00056 * sin(radians(psi - omega_3)) \
               - 0.00054 * sin(radians(l_3 - 2 * l_4 + pi_3)) \
               + 0.00051 * sin(radians(l_2 - l_4)) \
               + 0.00042 * sin(radians(2 * (psi - G - PI))) \
               + 0.00039 * sin(radians(2 * (pi_4 - omega_4))) \
               + 0.00036 * sin(radians(psi + PI - pi_4 - omega_4)) \
               + 0.00035 * sin(radians(2 * G_ - G + 188.37)) \
               - 0.00035 * sin(radians(l_4 - pi_4 + 2 * PI - 2 * psi)) \
               - 0.00032 * sin(radians(l_4 + pi_4 - 2 * PI - G)) \
               + 0.00030 * sin(radians(2 * G_ - 2 * G + 149.15)) \
               + 0.00029 * sin(radians(3 * l_3 - 7 * l_4 + 2 * pi_3 + 2 * pi_4)) \
               + 0.00028 * sin(radians(l_4 - pi_4 + 2 * psi - 2 * PI)) \
               - 0.00028 * sin(radians(2 * (l_4 - omega_4))) \
               - 0.00027 * sin(radians(pi_3 - pi_4 + omega_3 - omega_4)) \
               - 0.00026 * sin(radians(5 * G_ - 3 * G + 188.37)) \
               + 0.00025 * sin(radians(omega_4 - omega_3)) \
               - 0.00025 * sin(radians(l_2 - 3 * l_3 + 2 * l_4)) \
               - 0.00023 * sin(radians(3 * (l_3 - l_4))) \
               + 0.00021 * sin(radians(2 * l_4 - 2 * PI - 3 * G)) \
               - 0.00021 * sin(radians(2 * l_3 - 3 * l_4 + pi_4)) \
               + 0.00019 * sin(radians(l_4 - pi_4 - G)) \
               - 0.00019 * sin(radians(2 * l_4 - pi_3 - pi_4)) \
               - 0.00018 * sin(radians(l_4 - pi_4 + G)) \
               - 0.00016 * sin(radians(l_4 + pi_3 - 2 * PI - 2 * G))
        ...
        sum_r_1 = -0.0041339 * cos(radians((2 * (l_1 - l_2)))) \
                  - 0.0000387 * cos(radians((l_1 - pi_3))) \
                  - 0.0000214 * cos(radians((l_1 - pi_4))) \
                  + 0.0000170 * cos(radians((l_1 - l_2))) \
                  - 0.0000131 * cos(radians((4 * (l_1 - l_2)))) \
                  + 0.0000106 * cos(radians((l_1 - l_3))) \
                  - 0.0000066 * cos(radians((l_1 + pi_3 - 2 * PI - 2 * G)))

        sum_r_2 = +0.0093848 * cos(radians((l_1 - l_2))) \
                  - 0.0003116 * cos(radians((l_2 - pi_3))) \
                  - 0.0001744 * cos(radians((l_2 - pi_4))) \
                  - 0.0001442 * cos(radians((l_2 - pi_2))) \
                  + 0.0000553 * cos(radians((l_2 - l_3))) \
                  + 0.0000523 * cos(radians((l_1 - l_3))) \
                  - 0.0000290 * cos(radians((2 * (l_1 - l_2)))) \
                  + 0.0000164 * cos(radians((2 * (l_2 - omega_2)))) \
                  + 0.0000107 * cos(radians((l_1 - 2 * l_3 + pi_3))) \
                  - 0.0000102 * cos(radians((l_2 - pi_1))) \
                  - 0.0000091 * cos(radians((2 * (l_1 - l_3))))

        sum_r_3 = -0.0014388 * cos(radians((l_3 - pi_3))) \
                  - 0.0007919 * cos(radians((l_3 - pi_4))) \
                  + 0.0006342 * cos(radians((l_2 - l_3))) \
                  - 0.0001761 * cos(radians((2 * (l_3 - l_4)))) \
                  + 0.0000294 * cos(radians((l_3 - l_4))) \
                  - 0.0000156 * cos(radians((3 * (l_3 - l_4)))) \
                  + 0.0000156 * cos(radians((l_1 - l_3))) \
                  - 0.0000153 * cos(radians((l_1 - l_2))) \
                  + 0.0000070 * cos(radians((2 * l_2 - 3 * l_3 + pi_3))) \
                  - 0.0000051 * cos(radians((l_3 + pi_3 - 2 * PI - 2 * G)))

        sum_r_4 = -0.0073546 * cos(radians((l_4 - pi_4))) \
                  + 0.0001621 * cos(radians((l_4 - pi_3))) \
                  + 0.0000974 * cos(radians((l_3 - l_4))) \
                  - 0.0000543 * cos(radians((l_4 + pi_4 - 2 * PI - 2 * G))) \
                  - 0.0000271 * cos(radians((2 * (l_4 - pi_4)))) \
                  + 0.0000182 * cos(radians((l_4 - PI))) \
                  + 0.0000177 * cos(radians((2 * (l_3 - l_4)))) \
                  - 0.0000167 * cos(radians((2 * l_4 - psi - omega_4))) \
                  + 0.0000167 * cos(radians((psi - omega_4))) \
                  - 0.0000155 * cos(radians((2 * (l_4 - PI - G)))) \
                  + 0.0000142 * cos(radians((2 * (l_4 - psi)))) \
                  + 0.0000105 * cos(radians((l_1 - l_4))) \
                  + 0.0000092 * cos(radians((l_2 - l_4))) \
                  - 0.0000089 * cos(radians((l_4 - PI - G))) \
                  - 0.0000062 * cos(radians((l_4 + pi_4 - 2 * PI - 3 * G))) \
                  + 0.0000048 * cos(radians((2 * (l_4 - omega_4))))
    ...
    def check_phenomena(epoch, check_all=True, i_sat=0):
        ...
        [-3.457757270630766, -2.553301264153796]
        >>> print(result_matrix[1])
        [-7.44770945299594, -8.33419997337025]
        >>> print(result_matrix[2])
        [-1.3572840767173413, -3.817302564886177]
        >>> print(result_matrix[3])
        [-7.157430454898491, -11.373611474420906]
        ...
        >>> print(result_matrix[3])
        [-2.9341209155813894, -3.990459815299838]
        """
...
def main():
    ...
    # for the 16.12.1992 at 0h UTC, using the E5-theory.
    utc_1992_12_16_00_00_00 = Epoch(1992, 12, 16, utc=True)
    io, europa, ganymede, callisto = \
        JupiterMoons.rectangular_positions_jovian_equatorial(
            utc_1992_12_16_00_00_00)
    ...
    # Lets calculate the distance between Earth and Jupiter (DELTA)
    # for the 16.12.1992 at 0h UTC.
    utc_1992_12_16_00_00_00 = Epoch(1992, 12, 16, utc=True)
    ...
    # satellites is detected for the 12.02.2021 14h 19min 12s Terrestrial Time
    ...
    # print Row 0
    print("(Occultation of Io, Eclipse of Io): ")
    print(result_matrix[0])
    # [False, True]
    ...
    # print Row 2
    print(" (Occultation of Ganymede, Eclipse of Gaymede): ")
    print(result_matrix[2])
    # [False,False]
